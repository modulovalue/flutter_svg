...
// import 'util.dart';
//
// // TODO avd needs its own hierarchy, one that is not Dsvg.
//
...
//         avdStringDecoderIsOutsideViewBoxBuilder(
...
//     );
//
// PictureInfoDecoderBuilder<String> avdStringDecoderIsOutsideViewBoxBuilder(
...
//             );
//
// PictureInfoDecoderBuilder<Uint8List> avdBytesDecoderIsOutsideViewBoxBuilder(
//   final bool outsideViewBox,
// ) =>
//     (final DsvgTheme theme) => (
...
//   final SvgErrorDelegate errorDelegate,
// ) async {
//   final avdRoot = await _avdFromBytes(raw, errorDelegate);
...
//   final SvgErrorDelegate errorDelegate,
// ) async {
//   final avdRoot = _avdFromString(raw, errorDelegate);
//   final pic = await renderRootToPicture(
//     drawableRoot: avdRoot,
//     clipToViewBox: () {
//       if (allowDrawingOutsideOfViewBox == true) {
...
//   final SvgErrorDelegate errorDelegate,
// ) {
//   final svg = XmlDocument.parse(rawSvg).rootElement;
//   final viewBox = _parseViewBox(
//     svg.attributes,
//   );
//   final children = svg.children
//       .whereType<XmlElement>()
//       .map(
//         (final XmlElement child) => _parseAvdElement(
//           child,
//           dsvgRectToFlutter(
//             viewBox.viewBoxRect,
//           ),
