...
Future<void> _checkWidgetAndGolden(
  final Key key,
...
void main() {
  ...
  testWidgets('SvgPicture does invalidate the cache when color changes and color filter is cached',
      (WidgetTester tester) async {
    expect(pictureCacheSingleton.count, 0);
    await tester.pumpWidget(
      svgPictureFromString(
  ...
  testWidgets('SvgPicture does invalidate the cache when color changes and color filter is cached (override)',
      (WidgetTester tester) async {
    cacheColorFilterOverride = true;
    expect(pictureCacheSingleton.count, 0);
    await tester.pumpWidget(
      svgPictureFromString(
        string: svgStr,
  ...
  testWidgets('svgPictureFromString', (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MediaQuery(
  ...
  testWidgets('svgPictureFromString ltr', (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MediaQuery(
        data: MediaQueryData.fromWindow(window),
  ...
  testWidgets('svgPictureFromString rtl', (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MediaQuery(
        data: MediaQueryData.fromWindow(window),
  ...
  testWidgets('Nested SVG elements report a FlutterError', (WidgetTester tester) async {
    parseSvg(
      xml: '<svg viewBox="0 0 166 202"><svg viewBox="0 0 166 202"></svg></svg>',
  ...
  testWidgets('svgPictureFromString respects clipBehavior', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: svgPictureFromString(string: svgStr,),
    ));
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: svgPictureFromString(string: svgStr, clipBehavior: Clip.antiAlias,),
      ),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('SvgPicture.memory respects clipBehavior', (WidgetTester tester) async {
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: svgPictureFromMemory(svgBytes),
    ));
    await tester.pumpAndSettle();
    // Check that the render object has received the default clip behavior.
    final RenderFittedBox renderObject = tester.allRenderObjects.whereType<RenderFittedBox>().first;
    ...
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: svgPictureFromMemory(svgBytes, clipBehavior: Clip.antiAlias),
      ),
    );
    await tester.pumpAndSettle();
    expect(renderObject.clipBehavior, equals(Clip.antiAlias));
...
''';
      await tester.pumpWidget(
        RepaintBoundary(
          ...
          child: svgPictureFromString(
            string: svgStr,
            theme: const DsvgThemeImpl(fontSize: 600),
          ),
        ),
      );
      await tester.pumpAndSettle();
...
''';
      await tester.pumpWidget(
        RepaintBoundary(
          ...
          child: svgPictureFromString(
            string: svgStr,
            theme: const DsvgThemeImpl(fontSize: 100),
          ),
        ),
      );
      await tester.pumpAndSettle();
...
''';
  ...
  testWidgets('SvgPicture - two of the same', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(RepaintBoundary(
      ...
      child: Row(
        children: <Widget>[
          svgPictureFromString(string: simpleSvg,),
          svgPictureFromString(string: simpleSvg,),
        ],
      ),
    )));
